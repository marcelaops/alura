...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Campo Nome não pode ser vazio' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], AtualizaUsuarioDTO.prototype, "nome", void 0);
__decorate([
    (0, class_validator_1.IsEmail)(undefined, { message: 'Campo email não pode ser vazio ou inválido' }),
    (0, email_eh_unico_validator_1.EmailEhUnico)({ message: 'Já existe um usuário com este email' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], AtualizaUsuarioDTO.prototype, "email", void 0);
__decorate([
    (0, class_validator_1.MinLength)(6, { message: 'Senha com no mínimo 6 caractéres' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
